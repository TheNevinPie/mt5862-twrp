...
TARGET_BOARD_PLATFORM := mt5862               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := mt5862     # From ro.product.board
...
TW_THEME := landscape_mdpi                     # Set the exact theme you wanna use. If resulation doesn't match, define the height/width
...
TW_MAX_BRIGHTNESS := 1
TW_DEFAULT_BRIGHTNESS := 1                   # Set custom brightness, low is better
...
BOARD_MKBOOTIMG_ARGS := --ramdisk_offset 0x0108000 --second_offset  0x00F08000 --tags_offset 0x00008100
